<?php include_once ("structure/header.php"); ?>
  ...
  <form action="./action/verej6.php" method="post" onsubmit = "return validarDeportes()">
    ...
    <input type="checkbox" name="deporte[]" id="tennis" value="tennis">
